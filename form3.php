...
<body class="vh-100 bg-dark">
    ...
    <section class="container-fluid">
        <div class="studentForm1 my-5 text-start container">
            <form action="form4.php" class="mx-3">

                <h2 class="text-center mb-2 mt-4">Parenthood <span class="fs-5">(Fill where is apprpriate)</span></h2>
                <div class="form1h mb-5"></div>

                <div class="father mb-4 bg-dark">
                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="Gasabo#example" maxlength="30">
                        <label for="floatingInput">Father's Name</label>
                    </div>

                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="18">
                        <label for="floatingInput">His id</label>
                    </div>

                    <div class="form-floating mb-3 input-box">
                        <input type="tel" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="10">
                        <label for="floatingInput">His Tel No</label>
                    </div>                    
                </div>

                <hr class="text-warning">
                <div class="mother mb-4 bg-info">
                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="Gasabo#example" maxlength="30">
                    ...
                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="18">
                        <label for="floatingInput">Her id</label>
                    </div>

                    <div class="form-floating mb-3 input-box">
                        <input type="tel" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="10">
                        <label for="floatingInput">Her Tel No</label>
                    </div>                    
                </div>
             
                <hr class="text-warning">
                <div class="guardian bg-secondary">
                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="Gasabo#example" maxlength="30">
                    ...
                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="18">
                        <label for="floatingInput">His/Her id</label>
                    </div>

                    <div class="form-floating mb-3 input-box">
                        <input type="tel" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="10">
                        <label for="floatingInput">His/Her Tel No</label>
                    </div>                    
                </div>
                ...
                <div class="text-center text-dark">
                    <p><i class="bi bi-hand-thumbs-up"></i><a href="form4.html" class="text-decoration-none text-white">Next</a>
                        Thank you for registering your parenthoods details information ?
