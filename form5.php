...
<body class="vh-100 bg-dark">
    ...
    <section class="container-fluid">
        <div class="studentForm1 my-5 text-start container">
            <form action="register.php" method="POST" class="mx-3">

                <h2 class="text-black text-center mb-3 mt-4">Other Helpful Information</h2>
                <div class="form1h"></div>
                
                <!-- other info -->
                <div class="other mt-5">
                    <div class="input-group bg-white mt-5 input-box">
                        <span class="input-group-text"><i class="bi bi-hospital"></i></span>
                        <div class="form-floating">
                          <input type="text" class="form-control" id="floatingInputGroup1" placeholder="Username" maxlength="25">
                          <label for="floatingInputGroup1">Medical Insurance</label>
                        </div>
                    </div>
                    
                    <div class="input-group bg-white mt-2 input-box">
                        <span class="input-group-text"><i class="bi bi-align-center"></i></span>
                        <div class="form-floating">
                          <input type="text" class="form-control" id="floatingInputGroup1" placeholder="Username" maxlength="25">
                          <label for="floatingInputGroup1">Religion</label>
                        </div>
                    </div>

                    <div class="input-group bg-white mb-3 mt-2 input-box">
                        <span class="input-group-text"><i class="bi bi-bicycle"></i></span>
                        <div class="form-floating">
                          <input type="text" class="form-control" id="floatingInputGroup1" placeholder="Username" maxlength="25">
                          <label for="floatingInputGroup1">Sport</label>
                        </div>
                    </div>
                </div>
                ...
                <!-- sponser -->
                <div class="sponser mt-4">
                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="Gasabo#example" maxlength="25">
                        <label for="floatingInput">Sponsorship Type</label>
                    </div>
                </div>

                

                <div class="visitors mt-4">
                    <h2 class="text-dark text-center mb-3 mt-4">Three authorized people to visit you</h2>
                    <div class="form1h mb-4"></div>

                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="1st Name" aria-label="Username" maxlength="25">
                        <span class="input-group-text"><i class="bi bi-person-heart"></i></span>
                        <input type="text" class="form-control" placeholder="Relation" aria-label="Server" maxlength="25">
                    </div>

                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="2nd Name" aria-label="Username" maxlength="25">
                        <span class="input-group-text"><i class="bi bi-person-heart"></i></span>
                        <input type="text" class="form-control" placeholder="Relation" aria-label="Server" maxlength="25">
                    </div>

                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="3rd Name" aria-label="Username" maxlength="25">
                        <span class="input-group-text"><i class="bi bi-person-heart"></i></span>
                        <input type="text" class="form-control" placeholder="Relation" aria-label="Server" maxlength="25">
                    </div>
                ...
                <button type="submit" class="w-100 bg-dark my-3">
                    <a href="form5.html" class="text-decoration-none text-white">Submit</a></button>

                <div class="text-center text-dark">
                    <p><i class="bi bi-hand-thumbs-up"></i><a href="form5.html" class="text-decoration-none text-white">Next</a>
                        Make sure that all informayion provided are true ?
                        <i class="bi bi-hand-thumbs-up"></i>
                    </p>
                    <p class="text-warning">5/5</p>
                </div>
