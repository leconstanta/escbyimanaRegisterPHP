...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px;">
    ...
    <img src="images/byimanalogo.png" alt="" width="32" height="32" class="rounded-circle me-2">
                            ...
                            <div class="row col-md-12">
                                <form action="" method="GET">
                                    <div class="input-group mb-3">
                                        <input type="text" name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" class="form-control" placeholder="Student's name or school">
                        ...
                        <caption>List of users</caption>
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['search']))
                                {
                                    ...
                                    $query = "SELECT * FROM student_info WHERE CONCAT(firstname,lastname,school) LIKE '%$filtervalues%' ";
                ...
                <div class="col-lg-md-12">
                    <p>Copyright &copy; 2025 Ecole Des Science Byimana All Rights Reserved.
                        <a href="#" class="position-absolute bottom-0 end-0 p-5 text-warning">
                            <i class="bi bi-airplane-engines text-white h1 arrow"></i>
                        </a>
                    </p>
                </div>
