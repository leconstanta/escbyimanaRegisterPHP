...
<body class="vh-100 bg-dark">
    ...
    <nav class="navbar navbar-expand-lg  bg-white">
        <div class="container">
            ...
            align-items-center fs-5 flex-grow-1 pe-3">
                ...
                <li class="nav-item mx-2">
                    <a class="nav-link active" style="color: rgba(46, 46, 229, 0.762);" href="admin.php">Adminstration</a>
                </li>
                <li class="nav-item mx-2">
    ...
    <section class="container-fluid loginInterface"
    style="background: linear-gradient(to left, #fff 50%, #000000 50%);">
        <div class="login-box">
            <form action="logadmin.php" method="POST" id="form">
                ...
                <button type="submit" value="Login" name="submit" class="w-100 login">Login</button>

                <div class="text-center text-black register-link">
