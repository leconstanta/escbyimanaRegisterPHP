...
<body class="vh-100 bg-dark">
    ...
    <section class="container-fluid">
        <div class="studentForm1 my-5 text-start container">
            <form action="form3.php" method="POST" class="mx-3">

                <h2 class="text-center mb-3 mt-4">Birth Details</h2>
                <div class="form1h"></div>
                
                <!-- province -->
                <label for="exampleDataList" class="form-label text-dark mt-5">Province</label>
                <input class="form-control mb-3" list="datalistOptions" id="exampleDataList" placeholder="Type province here to search..." maxlength="30">
                <datalist id="datalistOptions">
                    <option value="Kigali city">
                    <option value="Northen Province">
                    <option value="Southern Province">
                    <option value="Easter Province">
                ...
                <!-- sector -->
                <div class="form-floating mb-3 input-box">
                    <input type="text" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="30">
                ...
                <div class="text-center text-black">
                    <p><i class="bi bi-hand-thumbs-up"></i><a href="form3.html" class="text-decoration-none text-white">Next</a>
                        Thank you for registering your birth details information ?
                        <i class="bi bi-hand-thumbs-up"></i>
                    </p>
                    <p class="text-warning">2/5</p>
                </div>
