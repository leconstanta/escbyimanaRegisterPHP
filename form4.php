...
<body class="vh-100 bg-dark">
    ...
    <section class="container-fluid">
        <div class="studentForm1 my-5 text-start container">
            <form action="form5.php" method="POST" class="mx-3">

                <h2 class="text-dark text-center mb-3 mt-4">Residence Details</h2>
                <div class="form1h"></div>
                
                <div class="residence mt-5">
                    ...
                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="25">
                        <label for="floatingInput">Sector</label>
                    </div>

                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="25">
                        <label for="floatingInput">Cell</label>
                    </div>
                ...
                <!--  -->
                <div class="preschool mt-4">
                    <h2 class="text-black text-center mb-3 mt-4">Previous school attended information</h2>
                    ...
                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="35">
                    ...
                    <div class="form-floating mb-3 input-box">
                        <select class="form-select form-select-sm" id="floatingSelect" aria-label="Floating label select example">
                          <option selected>Choose Your Previous class</option>
                    ...
                    <div class="form-floating mb-3 input-box">
                        <input type="number" class="form-control" id="floatingInput" placeholder="kimironko#example" max="2024" min="2020">
                        <label for="floatingInput">Academic year</label>
                    </div>

                    <div class="form-floating mb-3 input-box">
                        <input type="text" class="form-control" id="floatingInput" placeholder="kimironko#example" maxlength="2">
                        <label for="floatingInput">National Examination Aggregates</label>
                    </div>
                ...
                <div class="text-center text-black">
                    <p><i class="bi bi-hand-thumbs-up"></i><a href="form5.html" class="text-decoration-none text-white">Next</a>
                        Thank you for registering your birth details information ?
